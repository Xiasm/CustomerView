...
public class CountdownView extends View {
    ...
    public CountdownView(Context context, @Nullable AttributeSet attrs) {
        ...
        strokeColor = typedArray.getColor(R.styleable.CountdownView_strokeColor, Color.parseColor("#b7b5b5"));
        strokeWidth = typedArray.getDimension(R.styleable.CountdownView_strokeWidth, 5);
        loadingColor = typedArray.getColor(R.styleable.CountdownView_loadingColor, Color.parseColor("#ffffff"));
        loadingWidth = typedArray.getDimension(R.styleable.CountdownView_loadingWidth, 10);
        numberColor = typedArray.getColor(R.styleable.CountdownView_numberColor, Color.parseColor("#3d3d3d"));
        numberSize = typedArray.getDimension(R.styleable.CountdownView_numberSize, dp2px(22));
        numberSuffixText = typedArray.getString(R.styleable.CountdownView_numberSuffixText);
        numberSuffixColor = typedArray.getColor(R.styleable.CountdownView_numberSuffixColor, Color.parseColor("#3d3d3d"));
        numberSuffixSize = typedArray.getDimension(R.styleable.CountdownView_numberSuffixSize, dp2px(15));
        typedArray.recycle();
        init();
    }
